                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="/admin/showProduct" class="dropdown-item active">Show Product</a>
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Kenzy send you a message</h6>
                ...
                <div class="row vh-100 bg-light rounded align-items-start justify-content-center mx-0">
                    <form class="form-inline" action="${base }/admin/showProduct" method="get">
						...
						<div class="d-flex flex-row justify-content-between mt-4">
							...
							<div>
								<a class="btn btn-outline-primary mb-1" href="${base }/admin/addProduct" role="button">
									Add New
								</a>
							</div>
						</div>
                                    ...
                                    <td width="25%">
                                        <div>
                                            ...
                                            <c:if test="${product.status==true}">
                                                <a class="btn btn-danger" role="button" onclick="DeleteProduct(${product.id});">Block</a>
                                            </c:if>
                                            <c:if test="${product.status==false}">
                                                <a class="btn btn-danger" role="button" onclick="ActiveProduct(${product.id});">Active</a>
                                            </c:if>
                                            <a class="btn btn-primary" href="${base }/detail/${product.seo}" role="button">View</a>
                                        </div>
                                    </td>
                                </tr>
                                </c:forEach>
