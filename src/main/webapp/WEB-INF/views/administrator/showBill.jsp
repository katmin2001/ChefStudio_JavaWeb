...
<body>
                ...
                <div class="row vh-100 bg-light rounded align-items-start justify-content-center mx-0">
                    <form class="form-inline" action="${base }/admin/showProduct" method="get">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <c:forEach items="${saleOrder }" var="saleOrder">
                                <tr> 
    ...
    <script type="text/javascript">
        ...
        function DeleteBill(saleOrderId) {
            ...
            jQuery.ajax({
                url:  '${base}' + "/admin/delete2", //->request mapping
        ...
        function ActiveBill(saleOrderId) {
            // tạo javascript object.  
            var data = {
                id: saleOrderId,
            };
            ...
            // json == javascript object
            jQuery.ajax({
                url:  '${base}' + "/admin/active2", //->request mapping
                type: "post",					//-> method type cá»§a Request Mapping	
                contentType: "application/json",//-> ná»i dung gá»­i lÃªn dáº¡ng json
                data: JSON.stringify(data),
