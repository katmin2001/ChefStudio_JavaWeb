        ...
        <div class="container">
            <div class="row1">
                ...
                <div class="content_right">
                    <form class="form-inline" action="${base }/product-list/${searchModel.categorySeo }" method="get">
                        <div class="page_bar">
                            <div class="row2">
                                <div class="title">
                                    Sản phẩm
                                ...
                                <div class="search">
                                        <div class="search_r">
                                            <!-- <h1>${searchModel.sort_by }</h1> -->
                                           
                                            <input hidden id="page_1" name="page">
                                            ...
                                            <select name="sort_by" id="sort_by">
                                             ...
                                             <button class="filter" type="submit" id="btnCheck" name="btnCheck" value="Search" ><i class="fa-solid fa-filter"></i></button>
                                        </div>
                                </div>
                            </div>
